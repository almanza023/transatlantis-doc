<div id="modalEdit" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form  method="POST" action="{{ route('type-obtainments.update', 'type') }}" id="form_edit">
          @csrf
          @method('PUT')
          <fieldset>         
            <input class='form-control'  type='hidden' name="id_type_obtainment" id="id_type_obtainment">            
